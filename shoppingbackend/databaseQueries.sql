...
VALUES ('Gitesh', 'Bhoir', 'ADMIN', 'true', 'admin', 'gbcluster@gmail.com', '8898844217');

INSERT INTO user_detail
(first_name, last_name, role, enabled, password, email, contact_number)
VALUES ('Bhoomi', 'Pokar', 'SUPPLIER', 'true', '12345', 'gbcluster@gmail.com', '976991551');

INSERT INTO user_detail
(first_name, last_name, role, enabled, password, email, contact_number)
VALUES ('Atul', 'Farde', 'SUPPLIER', 'true', '123456', 'Atulfarde@gmail.com', '7798860968');
...
CREATE TABLE product(
	...
	CONSTRAINT fk_prodcut_category_id FOREIGN KEY (category_id) REFERENCES category (id),
